...
// $sql = 'SELECT * FROM tozan_record_table
// LEFT OUTER JOIN tozan_record_like_table ON
// tozan_record_like_table.like_image_id = tozan_record_table.image_id
//   WHERE tozan_record_table.user_id = :user_id
...
// $sql = 'SELECT DISTINCT image_id,username,image_name,image_id,name,maximumAltitude,date,time,distance,like_user_id,users_table.id
// FROM
// tozan_record_table
// LEFT OUTER JOIN
// tozan_record_like_table
// ON
// tozan_record_like_table.like_image_id = tozan_record_table.image_id
// LEFT OUTER JOIN
// follow_table
// ON
// tozan_record_table.user_id = follow_table.follow_user_id
// LEFT OUTER JOIN
// users_table
// ON
// tozan_record_table.user_id = users_table.id
// WHERE
// follow_table.user_id=:user_id 
// AND ' ;
  ...
  <div class="container mt-5">
    <?php for ($i = 0; $i < count($records); $i++) : ?>
      <div class="thumbnail">
        ...
        <!-- <a class='far fa-thumbs-up' href='execution.php/like_create.php?user_id=<?php echo $user_id ?>&image_id=<?php echo $records[$i]['image_id'] ?>'></a> -->

        <!-- <a class='far fa-thumbs-up' href='execution.php/like_create.php?like_user_id=<?php echo $user_id ?>&image_id=<?php echo $records[$i]['image_id'] ?>&user_id=<?php echo $records[$i]['user_id'] ?>' style="color:red;"></a> -->

        <?php if ($records[$i]['like_user_id'] != NULL) : ?>

          <a class='fas fa-heart' href='execution.php/like_create.php?like_user_id=<?php echo $user_id ?>&image_id=<?php echo $records[$i]['image_id'] ?>&user_id=<?php echo $records[$i]['post_user_id'] ?>' style="color:red;"></a>
          <script>
          
          </script>
        <?php else : ?>

          <a class="far fa-heart" href='execution.php/like_create.php?like_user_id=<?php echo $user_id ?>&image_id=<?php echo $records[$i]['image_id'] ?>&user_id=<?php echo $records[$i]['post_user_id'] ?>'></a>
